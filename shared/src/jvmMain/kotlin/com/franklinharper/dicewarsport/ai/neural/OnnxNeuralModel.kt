...
/**
 * ONNX Runtime-backed implementation of [NeuralModel].
 *
 * Loads a model from the filesystem and runs inference using the ONNX Runtime
 * JVM API. Tensors are encoded by [NeuralOnnxInputEncoder] and decoded by
 * [NeuralOnnxOutputDecoder].
 */
class OnnxNeuralModel(
    modelBytes: ByteArray,
) : NeuralModel, AutoCloseable {

    constructor(modelPath: String) : this(java.io.File(modelPath).readBytes())
